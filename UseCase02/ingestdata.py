...
valid_records_df['ada_v2_embedding'] = valid_records_df['Content'].apply(lambda x: generate_embeddings(x, model='text-embedding-ada-002'))

# Save the DataFrame as a Parquet file
valid_records_df.to_parquet('url_contents.parquet')
